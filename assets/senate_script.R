##voting project: SENATE
##install.packages('dplyr')
library(dplyr)

setwd('/Users/lindsaycarbonell/Documents/REPOS/uncontested-candidates/assets/priprecinct/senate')
prec_2000 = read.csv('11072000_senate.csv', header = T)
prec_2002 = read.csv('11052002_senate.csv', header = T)
prec_2004 = read.csv('11022004_senate.csv', header = T)
prec_2006 = read.csv('11072006_senate.csv', header = T)
prec_2008 = read.csv('11042008_senate.csv', header = T)
prec_2010 = read.csv('11022010_senate.csv', header = T)
prec_2012 = read.csv('11062012_senate.csv', header = T)
...
##select cols needed and add district col
